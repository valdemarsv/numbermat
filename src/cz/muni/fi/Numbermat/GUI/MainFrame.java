...
public class MainFrame extends javax.swing.JFrame {
    ...
    public MainFrame() {
        ...
        final String pathToPDFExportFolder = preferences.get("pathToPDFExportFolder", null);
        if ((pathToPDFLaTeXFile == null) || (pathToPDFExportFolder == null))
            Config.initPreferences(preferences);
        if ((pathToPDFLaTeXFile != null) && (!pathToPDFLaTeXFile.equals(Config.DEFAULT)))
            Config.setPDFLaTeXFile(new File(pathToPDFLaTeXFile));
        if ((pathToPDFExportFolder != null) && (!pathToPDFExportFolder.equals(Config.DEFAULT)))
            Config.setPDFExportFolder(new File(pathToPDFExportFolder));
    ...
    private void initComponents() {
        ...
        logoField.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cz/muni/fi/Numbermat/GUI/Images/logo-numbermat.png"))); // NOI18N
        ...
        settingsButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cz/muni/fi/Numbermat/GUI/Images/settings-icon.png"))); // NOI18N
        settingsButton.setMnemonic('a');
        ...
        helpButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cz/muni/fi/Numbermat/GUI/Images/help-icon.png"))); // NOI18N
    ...
    private void checkButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkButtonActionPerformed
        ...
        switch (getSelectedProblemIndex()) {
            ...
            case Config.MOD_POW:
                actualResult = UserInputChecker.nonNegativeNumberResult(userAnswerField, this);
                break;
        ...
        if (!actualResult.isEmpty()) {
            if (actualResult.equals(expectedResult))
                checkIcon.setIcon(new ImageIcon(getClass().getResource(
                        "/cz/muni/fi/Numbermat/GUI/Images/correct.png")));
            else
                checkIcon.setIcon(new ImageIcon(getClass().getResource(
                        "/cz/muni/fi/Numbermat/GUI/Images/wrong.png")));
        }
    ...
    private void exportToPDFButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exportToPDFButtonActionPerformed
        ...
        File workingDir = Config.getPDFExportFolder();
        if (workingDir == null) {
    ...
    private void generateRandomButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generateRandomButtonActionPerformed
        ...
        final Class<? extends MathProblem> selectedProblemClass =
                Config.CLASSES.get(problemIndex);
    ...
    private void setParametersButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_setParametersButtonActionPerformed
        ...
        final List<String> texts = new ArrayList(
                Arrays.asList(Config.PARAMS[problemIndex]));
    ...
    private void generateWithParametersButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generateWithParametersButtonActionPerformed
        ...
        switch (getSelectedProblemIndex()) {
            case Config.GCD:
                params = UserInputChecker.checkIntegerParameters(
                        parameterArray, this, 2);
                if (!params.isEmpty())
                    mathProblem = new GCDProblem(params.get(0), params.get(1));
                break;
                
            case Config.BEZOUT:
                params = UserInputChecker.checkNonNegativeParameters(
                        parameterArray, this, 2);
                if (!params.isEmpty())
            ...
            case Config.INVERSE_MOD:
                ...
                if (!params.contains(null)) {
                    params = UserInputChecker.checkCoprimeParameters(
                            parameterArray, this, false);
                    if (!params.isEmpty())
            ...
            case Config.LINEAR_CONG:
                params = UserInputChecker.linearCongruenceNumberInput(
                        parameterArray, this);
                if (!params.isEmpty())
                    mathProblem = new LinearCongruenceProblem(params.get(0),
            ...
            case Config.UNIT_GROUP_ELEMENT_ORDER:
                params.add(UserInputChecker.positiveNumberInput(parameter1, this));
                params.add(UserInputChecker.numberInput(parameter2, this,
                        2, Config.MAX_INT, false));
                if (!params.contains(null)) {
                    params = UserInputChecker.checkCoprimeParameters(
                            parameterArray,this, true);
                    if (!params.isEmpty())
            ...
            case Config.QUADRATIC_CONG_GENERAL:
                ...
                if (!params.contains(null)) {
                    final JTextField[] inputFields = new JTextField[] {
            ...
            case Config.PERM_ORDER:
                final Integer size = UserInputChecker.numberInput(parameter1, this, 1, 10, false);
                if (size == null)
                    break;
